...
class ServerArgs:
    ...
    def add_cli_args(parser: argparse.ArgumentParser):
        ...
        parser.add_argument(
            "--apdative-speculative-batch_size-threshold",
            type=int,
            help="Disable speculative decoding when the number of running requests exceeds this threshold. For offline serving with decaying batch sizes, this enables adaptive switching between speculative and normal decoding.",
